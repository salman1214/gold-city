...
$(function() {
  ...
  var t = "";
  $("li a.open-menu").click(function() {
    t = $(this).attr("id");
    if ($(this).hasClass("active")) {
        // If already active, you might want to toggle or perform some other logic
    } else {
        // Reset and activate the current menu
        $(".open-menu").removeClass("active");
        $(this).addClass("active");

        // Handling the display of the mega menu
        ...
        if ($(".mega-active").css("visibility") === "hidden") {
            $(".bgfade-div").fadeOut();
        } else {
            $(".bgfade-div").fadeIn();
        }
