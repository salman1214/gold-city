...
function toggleMobSubMenu(e) {
  ...
  $(".sub-mob-menu").attr("style", "top: "+mastHeight+"px !important; height: calc(100% - "+mastHeight+"px) !important");
}
...
function toggleMobSubMenuActive(e) {
  $(".main-ctgry-menu").removeClass("active"), setTimeout(function() {
...
function menuSlideUp(t = !0) {
  $(".mega-menu .container").hide(), $(".mega-menu").removeClass("mega-active").css({
      ...
      $(".mega-menu").not($(this)).removeClass("active"), $(".mega-menu:not(.mega-active)").css("visibility", "hidden"), t && ($(".bgfade-div").fadeOut()), e()
  })
}
$(function() {
  ...
  $("li a.open-menu").mouseenter(function() {
      t = $(this).attr("id"), $(this).hasClass("active") ?  random_var='1' : ($(".open-menu").removeClass("active"), $(this).addClass("active"), $("." + t).css("height", "0px"), $(".mega-menu").removeClass("mega-active").css("visibility", "hidden"), $(".mega-menu .container").hide(), $("." + t).addClass("mega-active").css({
          visibility: "visible",
          height: "250px"
      }), $(".mega-menu").css("height", "250px"), $("." + t + " > .container").fadeIn("slow"), "hidden" == $(".mega-active").css("visibility") ? $(".bgfade-div").fadeOut() : $(".bgfade-div").fadeIn(),  $(".search-bx").removeClass("opened").fadeOut(400), hideSearchRes())
  }), $(".mega-menu").mouseleavee(function(e) {
      e = e.relatedTarget.className || e.toElement.className;
       !e || "border-bottom-sep" != e && "open-menu active" != e ? ( menuFirstHover = !(t = ""), menuSlideUp(), $(".open-menu").removeClass("active"), $(".search-bx").removeClass("opened").fadeOut(400), hideSearchRes()) : gem_old='1'
  }), $("div.top-bar, div.icons-bar, div.logo-wrap").mouseenter(function() {
      menuSlideUp(!1), $(".open-menu").removeClass("active"), $(".search-bx").hasClass("opened") || ($(".bgfade-div").delay(350).fadeOut())
      ...
      setTimeout(function() {
          $("#keyword").focus()
      }, 1e3), $(".search-bx").slideDown(800).addClass("opened"), $(".menu-accounts").css({
          visibility: "hidden",
          height: "0"
...
function getSearchResults(e) {
  if ("" === e) return $("#search_result_return").html(""), void $(".predictive-box").addClass("hidden").slideUp();
  if (!(e.length < 2)) {
      let i = new RegExp(e, "i"),
          n = "",
          a = 1;
      $.each(dataSearch, function(e, t) {
          -1 == t.title.search(i) && -1 == t.search_tags.search(i) || (n += '<li><a class="serach-item search_script" data-title="' + t.title + '" data-url="' + t.url + '">', n += t.title, n += "</a></li>", a++)
      }), 1 == a && (n = '<li class="search-no-result">No search results. Try searching something else.</li>'), $(".predictive-box").hasClass("hidden") && ($(".predictive-box").removeClass("hidden"), $(".predictive-box").slideDown()), $("#search_result_return").html(n)
  }
}! function() {
  ...
  $(".search-icon-img-top").on("click", function(e) {
      ...
      $(this).hasClass("active") || ($(".search-icon-img-top").removeClass("active"), $(this).addClass("active"), "light" != t && "dark" != t || (setPreferenceCookie(t), toggleTheme(t), toggleLogo(t)))
  })
}),
      ...
      setTimeout(function() {
          $.ajax({
              ...
              success: function(e) {
                  ...
                  }), $("#most_searches_new").html(i), $("#most_searches_new").removeClass("skeleton-effect-blink")
              }
          })
          ...
          $.ajax({
              ...
              success: function(e) {
                  ...
                  $.each(e, function(e, t) {
                      i += '<a class="search-result-capsule" href="' + n + t.url + '">' + t.title + "</a>"
                  }), $("#recent_searches_new").html(i), $("#recent_searches_new").removeClass("skeleton-effect-blink")
              }
          })
      }, 1e3)
  })
...
var swiperMain = new Swiper(".main-slider", {
  ...
  on: {
    slideChangeTransitionStart: function () {
      $('.banner-heading1').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-heading2').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-heading3').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-image1').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-image2').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-button1').removeClass('aos-init').removeClass('aos-animate');
      $('.banner-button2').removeClass('aos-init').removeClass('aos-animate');
    },
...
var swiperMain = new Swiper(".main-mobile-slider", {
  ...
  on: {
    slideChangeTransitionStart: function () {
      $('.banner-heading1').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-heading2').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-heading3').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-image1').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-image2').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-button1').removeClass('aos-init', 100).removeClass('aos-animate', 100);
      $('.banner-button2').removeClass('aos-init', 100).removeClass('aos-animate', 100);
    },
    slideChangeTransitionEnd: function () {
      AOS.init();
      AOS.refresh();
...
// tabs bullets
var swiper = new Swiper(".formTabsSwiper", {
  slidesPerView: 14,
  // pagination: {
  ...
  scrollbar: {
    el: ".formTabsSwiper-swiper-scrollbar",
    hide: true,
  },
});
...
// sol slider
var swiper = new Swiper(".solSwiper", {
  slidesPerView: 1,
  spaceBetween: 15,
  loop: true,
  breakpoints: {
...
// sol slider
var swiper = new Swiper(".solGalSwiper", {
  slidesPerView: 5,
  spaceBetween: 0,
  centeredSlides: true,
  loop:true,
...
*/
//# sourceURL=source.combined


$(".nav-btn").click(function() {
  if (window.innerWidth < 768) {
    var mastHeight = $('header').outerHeight();
    $(".mob-menu").attr("style", "top: "+mastHeight+"px !important; height: calc(100% - "+mastHeight+"px) !important");
    $(".sub-mob-menu").attr("style", "top: "+mastHeight+"px !important; height: calc(100% - "+mastHeight+"px) !important");
  }
});